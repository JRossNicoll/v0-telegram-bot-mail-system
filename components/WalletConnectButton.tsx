  ...
  if (connected && publicKey) {
    return (
      <div className="w-full flex flex-col items-center gap-3">
        <div className="w-full h-[52px] bg-[#16CE5E] text-[#000000] font-bold text-[15px] rounded-[14px] shadow-[0_8px_24px_rgba(22,206,94,0.35),0_4px_12px_rgba(0,0,0,0.12)] flex items-center justify-center gap-2">
